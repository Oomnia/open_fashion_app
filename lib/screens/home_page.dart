...
class HomePage extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      body: Stack(
        children: [
          CustomPositioned(svgpath: 'assets/svgs/10.svg', top: 10),
          CustomPositioned(svgpath: 'assets/svgs/October.svg', top: 40),
          CustomPositioned(svgpath: 'assets/svgs/Collection.svg', top: 85),
          Column(children: [
